...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/alert/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.96.0/docs/resources/alert snowflake_alert}.
type Alert interface {
	cdktf.TerraformResource
	Action() *string
	SetAction(val *string)
	ActionInput() *string
	AlertSchedule() AlertAlertScheduleOutputReference
	AlertScheduleInput() *AlertAlertSchedule
	// Experimental.
...
func (j *jsiiProxy_Alert) Action() *string {
	var returns *string
	_jsii_.Get(
		j,
		"action",
...
func (j *jsiiProxy_Alert) ActionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"actionInput",
...
func (j *jsiiProxy_Alert) AlertSchedule() AlertAlertScheduleOutputReference {
	var returns AlertAlertScheduleOutputReference
	_jsii_.Get(
		j,
		"alertSchedule",
		&returns,
...
func (j *jsiiProxy_Alert) AlertScheduleInput() *AlertAlertSchedule {
...
func (j *jsiiProxy_Alert) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_Alert) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_Alert) Condition() *string {
	var returns *string
	_jsii_.Get(
		j,
		"condition",
...
func (j *jsiiProxy_Alert) ConditionInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"conditionInput",
...
func (j *jsiiProxy_Alert) Database() *string {
	var returns *string
	_jsii_.Get(
		j,
		"database",
...
func (j *jsiiProxy_Alert) DatabaseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseInput",
...
func (j *jsiiProxy_Alert) Enabled() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabled",
...
func (j *jsiiProxy_Alert) EnabledInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"enabledInput",
...
func (j *jsiiProxy_Alert) FullyQualifiedName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fullyQualifiedName",
...
func (j *jsiiProxy_Alert) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_Alert) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_Alert) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_Alert) Schema() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schema",
...
func (j *jsiiProxy_Alert) SchemaInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaInput",
...
func (j *jsiiProxy_Alert) WarehouseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"warehouseInput",
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.96.0/docs/resources/alert snowflake_alert} Resource.
...
func (j *jsiiProxy_Alert)SetAction(val *string) {
...
func (j *jsiiProxy_Alert)SetComment(val *string) {
...
func (j *jsiiProxy_Alert)SetCondition(val *string) {
...
func (j *jsiiProxy_Alert)SetDatabase(val *string) {
...
func (j *jsiiProxy_Alert)SetEnabled(val interface{}) {
...
func (j *jsiiProxy_Alert)SetId(val *string) {
...
func (j *jsiiProxy_Alert)SetName(val *string) {
...
func (j *jsiiProxy_Alert)SetSchema(val *string) {
...
func (j *jsiiProxy_Alert)SetWarehouse(val *string) {
...
func (a *jsiiProxy_Alert) PutAlertSchedule(value *AlertAlertSchedule) {
	if err := a.validatePutAlertScheduleParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		a,
...
func (a *jsiiProxy_Alert) ResetComment() {
	_jsii_.InvokeVoid(
		a,
		"resetComment",
		nil, // no parameters
...
func (a *jsiiProxy_Alert) ResetEnabled() {
	_jsii_.InvokeVoid(
		a,
		"resetEnabled",
		nil, // no parameters
...
func (a *jsiiProxy_Alert) ResetId() {
	_jsii_.InvokeVoid(
		a,
		"resetId",
		nil, // no parameters
