...
func (j *jsiiProxy_Alert) validateSetActionParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Alert) validateSetCommentParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Alert) validateSetConditionParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Alert) validateSetDatabaseParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Alert) validateSetEnabledParameters(val interface{}) error {
	return nil
}

func (j *jsiiProxy_Alert) validateSetIdParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Alert) validateSetNameParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_Alert) validateSetSchemaParameters(val *string) error {
	return nil
}

func (j *jsiiProxy_Alert) validateSetWarehouseParameters(val *string) error {
	return nil
}
