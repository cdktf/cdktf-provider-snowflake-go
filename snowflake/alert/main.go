...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "alertSchedule", GoGetter: "AlertSchedule"},
			_jsii_.MemberProperty{JsiiProperty: "alertScheduleInput", GoGetter: "AlertScheduleInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putAlertSchedule", GoMethod: "PutAlertSchedule"},
			_jsii_.MemberMethod{JsiiMethod: "putTimeouts", GoMethod: "PutTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetAlertSchedule", GoMethod: "ResetAlertSchedule"},
