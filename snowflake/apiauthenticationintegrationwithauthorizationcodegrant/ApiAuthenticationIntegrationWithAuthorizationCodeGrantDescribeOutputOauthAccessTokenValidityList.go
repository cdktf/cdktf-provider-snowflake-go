...
func (a *jsiiProxy_ApiAuthenticationIntegrationWithAuthorizationCodeGrantDescribeOutputOauthAccessTokenValidityList) Resolve(context cdktf.IResolveContext) interface{} {
