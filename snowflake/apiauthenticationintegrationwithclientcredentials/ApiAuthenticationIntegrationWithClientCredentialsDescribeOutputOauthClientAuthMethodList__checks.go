...
func (a *jsiiProxy_ApiAuthenticationIntegrationWithClientCredentialsDescribeOutputOauthClientAuthMethodList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
