...
func (a *jsiiProxy_ApiAuthenticationIntegrationWithClientCredentialsDescribeOutputOauthRefreshTokenValidityList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
