...
func (c *jsiiProxy_ComputePoolShowOutputOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputePoolShowOutputOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
