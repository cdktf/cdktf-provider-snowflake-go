...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoSuspendSecsInput", GoGetter: "AutoSuspendSecsInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "forApplication", GoGetter: "ForApplication"},
			_jsii_.MemberProperty{JsiiProperty: "forApplicationInput", GoGetter: "ForApplicationInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAutoSuspendSecs", GoMethod: "ResetAutoSuspendSecs"},
			_jsii_.MemberMethod{JsiiMethod: "resetComment", GoMethod: "ResetComment"},
			_jsii_.MemberMethod{JsiiMethod: "resetForApplication", GoMethod: "ResetForApplication"},
