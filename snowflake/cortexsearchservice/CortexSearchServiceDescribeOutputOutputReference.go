...
func (c *jsiiProxy_CortexSearchServiceDescribeOutputOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CortexSearchServiceDescribeOutputOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
