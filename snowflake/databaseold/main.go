...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*DatabaseOld)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.databaseOld.DatabaseOldConfig",
		reflect.TypeOf((*DatabaseOldConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.databaseOld.DatabaseOldReplicationConfiguration",
		reflect.TypeOf((*DatabaseOldReplicationConfiguration)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-snowflake.databaseOld.DatabaseOldReplicationConfigurationOutputReference",
		reflect.TypeOf((*DatabaseOldReplicationConfigurationOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
