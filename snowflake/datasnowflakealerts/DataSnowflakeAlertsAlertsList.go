...
func (d *jsiiProxy_DataSnowflakeAlertsAlertsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeAlertsAlertsList) Resolve(context cdktf.IResolveContext) interface{} {
