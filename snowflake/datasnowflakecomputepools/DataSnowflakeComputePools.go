...
func (j *jsiiProxy_DataSnowflakeComputePools) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataSnowflakeComputePools) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataSnowflakeComputePools) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataSnowflakeComputePools) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataSnowflakeComputePools) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.10.0/docs/data-sources/compute_pools snowflake_compute_pools} Data Source.
...
func (j *jsiiProxy_DataSnowflakeComputePools)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataSnowflakeComputePools)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataSnowflakeComputePools)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func DataSnowflakeComputePools_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataSnowflakeComputePools) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeComputePools) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
