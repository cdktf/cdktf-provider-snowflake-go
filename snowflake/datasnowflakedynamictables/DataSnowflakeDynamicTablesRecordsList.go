...
func (d *jsiiProxy_DataSnowflakeDynamicTablesRecordsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeDynamicTablesRecordsList) Resolve(context cdktf.IResolveContext) interface{} {
