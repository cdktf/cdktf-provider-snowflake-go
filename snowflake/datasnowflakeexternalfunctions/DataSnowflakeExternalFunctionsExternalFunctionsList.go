...
func (d *jsiiProxy_DataSnowflakeExternalFunctionsExternalFunctionsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeExternalFunctionsExternalFunctionsList) Resolve(context cdktf.IResolveContext) interface{} {
