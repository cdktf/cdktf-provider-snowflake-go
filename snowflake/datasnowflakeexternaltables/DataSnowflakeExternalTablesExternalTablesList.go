...
func (d *jsiiProxy_DataSnowflakeExternalTablesExternalTablesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeExternalTablesExternalTablesList) Resolve(context cdktf.IResolveContext) interface{} {
