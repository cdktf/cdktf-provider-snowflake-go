...
func (d *jsiiProxy_DataSnowflakeExternalTablesExternalTablesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataSnowflakeExternalTablesExternalTablesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
