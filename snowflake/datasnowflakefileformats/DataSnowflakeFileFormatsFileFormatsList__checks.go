...
func (d *jsiiProxy_DataSnowflakeFileFormatsFileFormatsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataSnowflakeFileFormatsFileFormatsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
