...
func (j *jsiiProxy_DataSnowflakeGitRepositoriesGitRepositoriesDescribeOutputList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}
...
func validateNewDataSnowflakeGitRepositoriesGitRepositoriesDescribeOutputListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
