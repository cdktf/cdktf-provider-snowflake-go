...
func (d *jsiiProxy_DataSnowflakeGrantsGrantsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataSnowflakeGrantsGrantsList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
