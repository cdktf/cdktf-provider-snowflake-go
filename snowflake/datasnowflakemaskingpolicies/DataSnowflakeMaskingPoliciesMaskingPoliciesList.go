...
func (d *jsiiProxy_DataSnowflakeMaskingPoliciesMaskingPoliciesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeMaskingPoliciesMaskingPoliciesList) Resolve(context cdktf.IResolveContext) interface{} {
