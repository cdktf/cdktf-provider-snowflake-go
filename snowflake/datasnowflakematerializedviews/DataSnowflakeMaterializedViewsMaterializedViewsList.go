...
func (d *jsiiProxy_DataSnowflakeMaterializedViewsMaterializedViewsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeMaterializedViewsMaterializedViewsList) Resolve(context cdktf.IResolveContext) interface{} {
