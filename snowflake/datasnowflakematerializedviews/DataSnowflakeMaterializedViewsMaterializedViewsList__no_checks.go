...
func (d *jsiiProxy_DataSnowflakeMaterializedViewsMaterializedViewsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataSnowflakeMaterializedViewsMaterializedViewsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
