...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies) Database() *string {
	var returns *string
	_jsii_.Get(
		j,
		"database",
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies) DatabaseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseInput",
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies) Schema() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schema",
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies) SchemaInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaInput",
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.89.0/docs/data-sources/row_access_policies snowflake_row_access_policies} Data Source.
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies)SetDatabase(val *string) {
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataSnowflakeRowAccessPolicies)SetSchema(val *string) {
...
func (d *jsiiProxy_DataSnowflakeRowAccessPolicies) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeRowAccessPolicies) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
