...
func (d *jsiiProxy_DataSnowflakeSecurityIntegrationsSecurityIntegrationsDescribeOutputExternalOauthTokenUserMappingClaimList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
