...
func (d *jsiiProxy_DataSnowflakeSequencesSequencesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataSnowflakeSequencesSequencesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
