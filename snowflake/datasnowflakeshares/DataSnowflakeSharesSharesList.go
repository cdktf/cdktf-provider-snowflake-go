...
func (d *jsiiProxy_DataSnowflakeSharesSharesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeSharesSharesList) Resolve(context cdktf.IResolveContext) interface{} {
