...
func (d *jsiiProxy_DataSnowflakeStagesStagesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataSnowflakeStagesStagesList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
