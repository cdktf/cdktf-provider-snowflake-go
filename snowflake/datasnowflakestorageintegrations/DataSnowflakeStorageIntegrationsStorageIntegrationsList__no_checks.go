...
func (d *jsiiProxy_DataSnowflakeStorageIntegrationsStorageIntegrationsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}
...
func (d *jsiiProxy_DataSnowflakeStorageIntegrationsStorageIntegrationsList) validateResolveParameters(context cdktf.IResolveContext) error {
	return nil
}
