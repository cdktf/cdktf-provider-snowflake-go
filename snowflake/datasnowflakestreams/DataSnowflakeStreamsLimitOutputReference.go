...
func (d *jsiiProxy_DataSnowflakeStreamsLimitOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeStreamsLimitOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
