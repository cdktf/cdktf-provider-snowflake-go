...
func (d *jsiiProxy_DataSnowflakeTagsInOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeTagsInOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
