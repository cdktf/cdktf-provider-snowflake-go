...
func (j *jsiiProxy_DataSnowflakeTasks) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_DataSnowflakeTasks) Database() *string {
	var returns *string
	_jsii_.Get(
		j,
		"database",
...
func (j *jsiiProxy_DataSnowflakeTasks) DatabaseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseInput",
...
func (j *jsiiProxy_DataSnowflakeTasks) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_DataSnowflakeTasks) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_DataSnowflakeTasks) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_DataSnowflakeTasks) Schema() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schema",
...
func (j *jsiiProxy_DataSnowflakeTasks) SchemaInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaInput",
...
func (j *jsiiProxy_DataSnowflakeTasks) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_DataSnowflakeTasks)SetDatabase(val *string) {
...
func (j *jsiiProxy_DataSnowflakeTasks)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_DataSnowflakeTasks)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_DataSnowflakeTasks)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
func (j *jsiiProxy_DataSnowflakeTasks)SetSchema(val *string) {
...
func DataSnowflakeTasks_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (d *jsiiProxy_DataSnowflakeTasks) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeTasks) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
