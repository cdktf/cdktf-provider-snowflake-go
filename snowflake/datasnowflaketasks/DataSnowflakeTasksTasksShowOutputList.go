...
func (j *jsiiProxy_DataSnowflakeTasksTasksShowOutputList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataSnowflakeTasksTasksShowOutputList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataSnowflakeTasksTasksShowOutputList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataSnowflakeTasksTasksShowOutputList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataSnowflakeTasksTasksShowOutputList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataSnowflakeTasksTasksShowOutputList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataSnowflakeTasksTasksShowOutputList) Get(index *float64) DataSnowflakeTasksTasksShowOutputOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataSnowflakeTasksTasksShowOutputOutputReference
...
func (d *jsiiProxy_DataSnowflakeTasksTasksShowOutputList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataSnowflakeTasksTasksShowOutputList) ToString() *string {
	var returns *string
