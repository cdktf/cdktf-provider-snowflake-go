...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersDateInputFormatOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersDateInputFormatOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
