...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersJdbcTreatTimestampNtzAsUtcList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataSnowflakeUsersUsersParametersJdbcTreatTimestampNtzAsUtcList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataSnowflakeUsersUsersParametersJdbcTreatTimestampNtzAsUtcList {
	_init_.Initialize()
...
func NewDataSnowflakeUsersUsersParametersJdbcTreatTimestampNtzAsUtcList_Override(d DataSnowflakeUsersUsersParametersJdbcTreatTimestampNtzAsUtcList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersJdbcTreatTimestampNtzAsUtcList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersJdbcTreatTimestampNtzAsUtcList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersJdbcTreatTimestampNtzAsUtcList) Resolve(_context cdktf.IResolveContext) interface{} {
