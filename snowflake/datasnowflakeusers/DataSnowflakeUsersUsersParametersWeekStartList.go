...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersWeekStartList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersWeekStartList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersWeekStartList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersWeekStartList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataSnowflakeUsersUsersParametersWeekStartList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersWeekStartList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersWeekStartList) Get(index *float64) DataSnowflakeUsersUsersParametersWeekStartOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataSnowflakeUsersUsersParametersWeekStartOutputReference
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersWeekStartList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersParametersWeekStartList) ToString() *string {
	var returns *string
