...
func (d *jsiiProxy_DataSnowflakeUsersUsersShowOutputOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeUsersUsersShowOutputOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
