...
func (j *jsiiProxy_DataSnowflakeViews) Database() *string {
	var returns *string
	_jsii_.Get(
		j,
		"database",
...
func (j *jsiiProxy_DataSnowflakeViews) DatabaseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseInput",
...
func (j *jsiiProxy_DataSnowflakeViews) Schema() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schema",
...
func (j *jsiiProxy_DataSnowflakeViews) SchemaInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaInput",
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.75.0/docs/data-sources/views snowflake_views} Data Source.
...
func (j *jsiiProxy_DataSnowflakeViews)SetDatabase(val *string) {
...
func (j *jsiiProxy_DataSnowflakeViews)SetSchema(val *string) {
