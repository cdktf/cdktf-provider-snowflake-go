...
func (d *jsiiProxy_DataSnowflakeWarehousesWarehousesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataSnowflakeWarehousesWarehousesList) Resolve(context cdktf.IResolveContext) interface{} {
