...
// The jsii proxy struct for DataSnowflakeWarehousesWarehousesOutputReference
type jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference struct {
...
func (j *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) ComplexObjectIsFromSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) InternalValue() *DataSnowflakeWarehousesWarehouses {
	var returns *DataSnowflakeWarehousesWarehouses
	_jsii_.Get(
		j,
		"internalValue",
		&returns,
...
func (j *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func (d *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (d *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
...
func (d *jsiiProxy_DataSnowflakeWarehousesWarehousesOutputReference) ToString() *string {
	var returns *string
