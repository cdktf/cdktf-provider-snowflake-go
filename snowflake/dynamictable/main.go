...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "initialize", GoGetter: "Initialize"},
			_jsii_.MemberProperty{JsiiProperty: "initializeInput", GoGetter: "InitializeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putTargetLag", GoMethod: "PutTargetLag"},
			...
			_jsii_.MemberProperty{JsiiProperty: "refreshModeInput", GoGetter: "RefreshModeInput"},
			_jsii_.MemberProperty{JsiiProperty: "refreshModeReason", GoGetter: "RefreshModeReason"},
			_jsii_.MemberMethod{JsiiMethod: "resetComment", GoMethod: "ResetComment"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetInitialize", GoMethod: "ResetInitialize"},
			_jsii_.MemberMethod{JsiiMethod: "resetOrReplace", GoMethod: "ResetOrReplace"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRefreshMode", GoMethod: "ResetRefreshMode"},
			...
			_jsii_.MemberProperty{JsiiProperty: "targetLagInput", GoGetter: "TargetLagInput"},
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "downstream", GoGetter: "Downstream"},
			_jsii_.MemberProperty{JsiiProperty: "downstreamInput", GoGetter: "DownstreamInput"},
			_jsii_.MemberProperty{JsiiProperty: "fqn", GoGetter: "Fqn"},
			_jsii_.MemberMethod{JsiiMethod: "getAnyMapAttribute", GoMethod: "GetAnyMapAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanAttribute", GoMethod: "GetBooleanAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getBooleanMapAttribute", GoMethod: "GetBooleanMapAttribute"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDownstream", GoMethod: "ResetDownstream"},
