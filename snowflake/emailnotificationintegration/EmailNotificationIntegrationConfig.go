...
type EmailNotificationIntegrationConfig struct {
	...
	AllowedRecipients *[]*string `field:"optional" json:"allowedRecipients" yaml:"allowedRecipients"`
	...
	Timeouts *EmailNotificationIntegrationTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
