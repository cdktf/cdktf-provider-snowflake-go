...
type ExternalFunctionArg struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.66.1/docs/resources/external_function#type ExternalFunction#type}
