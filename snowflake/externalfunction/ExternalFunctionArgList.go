...
type ExternalFunctionArgList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ExternalFunctionArgOutputReference
...
// The jsii proxy struct for ExternalFunctionArgList
type jsiiProxy_ExternalFunctionArgList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ExternalFunctionArgList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ExternalFunctionArgList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ExternalFunctionArgList) InternalValue() interface{} {
...
func (j *jsiiProxy_ExternalFunctionArgList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ExternalFunctionArgList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ExternalFunctionArgList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (e *jsiiProxy_ExternalFunctionArgList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (e *jsiiProxy_ExternalFunctionArgList) ComputeFqn() *string {
	var returns *string
...
func (e *jsiiProxy_ExternalFunctionArgList) Resolve(context cdktf.IResolveContext) interface{} {
...
func (e *jsiiProxy_ExternalFunctionArgList) ToString() *string {
	var returns *string
