...
func (e *jsiiProxy_ExternalFunctionHeaderList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (e *jsiiProxy_ExternalFunctionHeaderList) validateResolveParameters(context cdktf.IResolveContext) error {
	if context == nil {
