...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "requestTranslator", GoGetter: "RequestTranslator"},
			_jsii_.MemberProperty{JsiiProperty: "requestTranslatorInput", GoGetter: "RequestTranslatorInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetRequestTranslator", GoMethod: "ResetRequestTranslator"},
			_jsii_.MemberMethod{JsiiMethod: "resetResponseTranslator", GoMethod: "ResetResponseTranslator"},
			_jsii_.MemberMethod{JsiiMethod: "resetReturnNullAllowed", GoMethod: "ResetReturnNullAllowed"},
			_jsii_.MemberProperty{JsiiProperty: "responseTranslator", GoGetter: "ResponseTranslator"},
			_jsii_.MemberProperty{JsiiProperty: "responseTranslatorInput", GoGetter: "ResponseTranslatorInput"},
