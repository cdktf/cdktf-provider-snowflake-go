...
import (
	...
	"github.com/hashicorp/cdktf-provider-snowflake-go/snowflake/v3/externaloauthintegration/internal"
...
func (j *jsiiProxy_ExternalOauthIntegration) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
