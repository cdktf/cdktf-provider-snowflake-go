...
func (e *jsiiProxy_ExternalTable) validatePutColumnParameters(value interface{}) error {
	...
	case *[]*ExternalTableColumn:
		value := value.(*[]*ExternalTableColumn)
	...
	case []*ExternalTableColumn:
		value_ := value.([]*ExternalTableColumn)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ExternalTableColumn; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_ExternalTable) validatePutTagParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ExternalTableTag; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ExternalTable) validateSetLifecycleParameters(val *cdktf.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
