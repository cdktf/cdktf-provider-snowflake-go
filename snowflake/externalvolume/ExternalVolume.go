...
type ExternalVolume interface {
	...
	ShowOutput() ExternalVolumeShowOutputList
	...
	PutStorageLocation(value interface{})
	PutTimeouts(value *ExternalVolumeTimeouts)
	ResetAllowWrites()
	ResetComment()
	ResetId()
...
func (j *jsiiProxy_ExternalVolume) AllowWritesInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"allowWritesInput",
...
func (j *jsiiProxy_ExternalVolume) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_ExternalVolume) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_ExternalVolume) DescribeOutput() ExternalVolumeDescribeOutputList {
	var returns ExternalVolumeDescribeOutputList
	_jsii_.Get(
		j,
		"describeOutput",
		&returns,
...
func (j *jsiiProxy_ExternalVolume) FullyQualifiedName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fullyQualifiedName",
...
func (j *jsiiProxy_ExternalVolume) ShowOutput() ExternalVolumeShowOutputList {
	var returns ExternalVolumeShowOutputList
	_jsii_.Get(
		j,
		"showOutput",
		&returns,
...
func (j *jsiiProxy_ExternalVolume) StorageLocation() ExternalVolumeStorageLocationList {
	var returns ExternalVolumeStorageLocationList
	_jsii_.Get(
		j,
		"storageLocation",
		&returns,
...
func (j *jsiiProxy_ExternalVolume) StorageLocationInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_ExternalVolume) Timeouts() ExternalVolumeTimeoutsOutputReference {
	var returns ExternalVolumeTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_ExternalVolume) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
func (j *jsiiProxy_ExternalVolume)SetAllowWrites(val *string) {
...
func (j *jsiiProxy_ExternalVolume)SetComment(val *string) {
...
func (e *jsiiProxy_ExternalVolume) HasResourceMove() interface{} {
	var returns interface{}
...
func (e *jsiiProxy_ExternalVolume) MoveFromId(id *string) {
...
func (e *jsiiProxy_ExternalVolume) MoveToId(id *string) {
...
func (e *jsiiProxy_ExternalVolume) PutStorageLocation(value interface{}) {
	if err := e.validatePutStorageLocationParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		e,
...
func (e *jsiiProxy_ExternalVolume) PutTimeouts(value *ExternalVolumeTimeouts) {
...
func (e *jsiiProxy_ExternalVolume) ResetAllowWrites() {
	_jsii_.InvokeVoid(
		e,
		"resetAllowWrites",
		nil, // no parameters
...
func (e *jsiiProxy_ExternalVolume) ResetComment() {
	_jsii_.InvokeVoid(
		e,
		"resetComment",
		nil, // no parameters
...
func (e *jsiiProxy_ExternalVolume) ResetTimeouts() {
	_jsii_.InvokeVoid(
		e,
		"resetTimeouts",
		nil, // no parameters
