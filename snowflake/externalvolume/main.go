...
func init() {
	...
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
			_jsii_.MemberProperty{JsiiProperty: "creationStack", GoGetter: "CreationStack"},
			_jsii_.MemberProperty{JsiiProperty: "encryptionKmsKeyId", GoGetter: "EncryptionKmsKeyId"},
			_jsii_.MemberProperty{JsiiProperty: "encryptionKmsKeyIdInput", GoGetter: "EncryptionKmsKeyIdInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetEncryptionKmsKeyId", GoMethod: "ResetEncryptionKmsKeyId"},
			...
			_jsii_.MemberProperty{JsiiProperty: "storageBaseUrl", GoGetter: "StorageBaseUrl"},
			_jsii_.MemberProperty{JsiiProperty: "storageBaseUrlInput", GoGetter: "StorageBaseUrlInput"},
			_jsii_.MemberProperty{JsiiProperty: "storageLocationName", GoGetter: "StorageLocationName"},
			_jsii_.MemberProperty{JsiiProperty: "storageLocationNameInput", GoGetter: "StorageLocationNameInput"},
