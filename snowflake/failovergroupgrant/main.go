...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FailoverGroupGrant)(nil)).Elem(),
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "failoverGroupNameInput", GoGetter: "FailoverGroupNameInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetFailoverGroupName", GoMethod: "ResetFailoverGroupName"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.failoverGroupGrant.FailoverGroupGrantConfig",
		reflect.TypeOf((*FailoverGroupGrantConfig)(nil)).Elem(),
	)
}
