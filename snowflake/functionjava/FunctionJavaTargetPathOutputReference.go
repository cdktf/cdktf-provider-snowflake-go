...
func (f *jsiiProxy_FunctionJavaTargetPathOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (f *jsiiProxy_FunctionJavaTargetPathOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
