...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.functionResource.FunctionResourceArguments",
		reflect.TypeOf((*FunctionResourceArguments)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-snowflake.functionResource.FunctionResourceArgumentsList",
		reflect.TypeOf((*FunctionResourceArgumentsList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*FunctionResourceArgumentsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
