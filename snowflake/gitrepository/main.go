...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "gitCredentialsInput", GoGetter: "GitCredentialsInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetGitCredentials", GoMethod: "ResetGitCredentials"},
