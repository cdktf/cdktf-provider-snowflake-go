...
func (g *jsiiProxy_GrantOwnershipOnAllOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GrantOwnershipOnAllOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
