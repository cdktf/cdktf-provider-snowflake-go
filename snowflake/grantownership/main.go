...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "outboundPrivileges", GoGetter: "OutboundPrivileges"},
			_jsii_.MemberProperty{JsiiProperty: "outboundPrivilegesInput", GoGetter: "OutboundPrivilegesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetAccountRoleName", GoMethod: "ResetAccountRoleName"},
			_jsii_.MemberMethod{JsiiMethod: "resetDatabaseRoleName", GoMethod: "ResetDatabaseRoleName"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetOutboundPrivileges", GoMethod: "ResetOutboundPrivileges"},
