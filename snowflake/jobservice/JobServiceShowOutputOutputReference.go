...
func (j *jsiiProxy_JobServiceShowOutputOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (j *jsiiProxy_JobServiceShowOutputOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
