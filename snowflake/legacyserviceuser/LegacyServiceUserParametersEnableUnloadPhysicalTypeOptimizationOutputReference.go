...
func (l *jsiiProxy_LegacyServiceUserParametersEnableUnloadPhysicalTypeOptimizationOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LegacyServiceUserParametersEnableUnloadPhysicalTypeOptimizationOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
