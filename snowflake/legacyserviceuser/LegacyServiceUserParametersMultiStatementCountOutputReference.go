...
func (l *jsiiProxy_LegacyServiceUserParametersMultiStatementCountOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (l *jsiiProxy_LegacyServiceUserParametersMultiStatementCountOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
