...
func (l *jsiiProxy_ListingManifestOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (l *jsiiProxy_ListingManifestOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
