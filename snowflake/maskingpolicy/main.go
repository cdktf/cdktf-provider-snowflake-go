...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "exemptOtherPoliciesInput", GoGetter: "ExemptOtherPoliciesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "putSignature", GoMethod: "PutSignature"},
			_jsii_.MemberProperty{JsiiProperty: "qualifiedName", GoGetter: "QualifiedName"},
			_jsii_.MemberProperty{JsiiProperty: "rawOverrides", GoGetter: "RawOverrides"},
			_jsii_.MemberMethod{JsiiMethod: "resetComment", GoMethod: "ResetComment"},
			_jsii_.MemberMethod{JsiiMethod: "resetExemptOtherPolicies", GoMethod: "ResetExemptOtherPolicies"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.maskingPolicy.MaskingPolicySignature",
		reflect.TypeOf((*MaskingPolicySignature)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.maskingPolicy.MaskingPolicySignatureColumn",
		reflect.TypeOf((*MaskingPolicySignatureColumn)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-snowflake.maskingPolicy.MaskingPolicySignatureColumnList",
		reflect.TypeOf((*MaskingPolicySignatureColumnList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MaskingPolicySignatureColumnOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*MaskingPolicySignatureOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
