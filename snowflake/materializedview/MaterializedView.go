...
func (j *jsiiProxy_MaterializedView) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_MaterializedView) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_MaterializedView) Connection() interface{} {
...
func (j *jsiiProxy_MaterializedView) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_MaterializedView) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_MaterializedView) Database() *string {
	var returns *string
	_jsii_.Get(
		j,
		"database",
...
func (j *jsiiProxy_MaterializedView) DatabaseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"databaseInput",
...
func (j *jsiiProxy_MaterializedView) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_MaterializedView) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_MaterializedView) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_MaterializedView) FullyQualifiedName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fullyQualifiedName",
...
func (j *jsiiProxy_MaterializedView) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_MaterializedView) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_MaterializedView) IsSecure() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isSecure",
...
func (j *jsiiProxy_MaterializedView) IsSecureInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"isSecureInput",
...
func (j *jsiiProxy_MaterializedView) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_MaterializedView) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_MaterializedView) Node() constructs.Node {
...
func (j *jsiiProxy_MaterializedView) OrReplace() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"orReplace",
...
func (j *jsiiProxy_MaterializedView) OrReplaceInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"orReplaceInput",
...
func (j *jsiiProxy_MaterializedView) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_MaterializedView) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_MaterializedView) Schema() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schema",
...
func (j *jsiiProxy_MaterializedView) SchemaInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"schemaInput",
...
func (j *jsiiProxy_MaterializedView) Statement() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statement",
...
func (j *jsiiProxy_MaterializedView) StatementInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"statementInput",
...
func (j *jsiiProxy_MaterializedView) Tag() MaterializedViewTagList {
	var returns MaterializedViewTagList
	_jsii_.Get(
		j,
		"tag",
		&returns,
...
func (j *jsiiProxy_MaterializedView) TagInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagInput",
...
func (j *jsiiProxy_MaterializedView) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MaterializedView) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_MaterializedView) WarehouseInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"warehouseInput",
...
func (j *jsiiProxy_MaterializedView)SetCount(val interface{}) {
...
// Experimental.
func MaterializedView_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMaterializedView_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func MaterializedView_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateMaterializedView_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func MaterializedView_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-snowflake.materializedView.MaterializedView",
...
func (m *jsiiProxy_MaterializedView) AddMoveTarget(moveTarget *string) {
...
func (m *jsiiProxy_MaterializedView) HasResourceMove() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MaterializedView) MoveFromId(id *string) {
...
func (m *jsiiProxy_MaterializedView) MoveTo(moveTarget *string, index interface{}) {
...
func (m *jsiiProxy_MaterializedView) MoveToId(id *string) {
...
func (m *jsiiProxy_MaterializedView) ResetId() {
	_jsii_.InvokeVoid(
		m,
		"resetId",
		nil, // no parameters
...
func (m *jsiiProxy_MaterializedView) ResetIsSecure() {
	_jsii_.InvokeVoid(
		m,
		"resetIsSecure",
		nil, // no parameters
...
func (m *jsiiProxy_MaterializedView) ResetOrReplace() {
	_jsii_.InvokeVoid(
		m,
		"resetOrReplace",
		nil, // no parameters
...
func (m *jsiiProxy_MaterializedView) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		m,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (m *jsiiProxy_MaterializedView) ResetTag() {
	_jsii_.InvokeVoid(
		m,
		"resetTag",
		nil, // no parameters
...
func (m *jsiiProxy_MaterializedView) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MaterializedView) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (m *jsiiProxy_MaterializedView) ToHclTerraform() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MaterializedView) ToMetadata() interface{} {
	var returns interface{}
...
func (m *jsiiProxy_MaterializedView) ToString() *string {
	var returns *string
...
func (m *jsiiProxy_MaterializedView) ToTerraform() interface{} {
	var returns interface{}
