...
type NetworkPolicy interface {
	...
	DescribeOutput() NetworkPolicyDescribeOutputList
	// Experimental.
	...
	ShowOutput() NetworkPolicyShowOutputList
	// Experimental.
	...
	PutTimeouts(value *NetworkPolicyTimeouts)
	ResetAllowedIpList()
...
func (j *jsiiProxy_NetworkPolicy) AllowedIpList() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"allowedIpList",
...
func (j *jsiiProxy_NetworkPolicy) AllowedIpListInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"allowedIpListInput",
...
func (j *jsiiProxy_NetworkPolicy) BlockedIpListInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"blockedIpListInput",
...
func (j *jsiiProxy_NetworkPolicy) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_NetworkPolicy) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_NetworkPolicy) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_NetworkPolicy) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_NetworkPolicy) DescribeOutput() NetworkPolicyDescribeOutputList {
	var returns NetworkPolicyDescribeOutputList
	_jsii_.Get(
		j,
		"describeOutput",
		&returns,
...
func (j *jsiiProxy_NetworkPolicy) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_NetworkPolicy) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetworkPolicy) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_NetworkPolicy) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetworkPolicy) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkPolicy) NameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"nameInput",
...
func (j *jsiiProxy_NetworkPolicy) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_NetworkPolicy) ShowOutput() NetworkPolicyShowOutputList {
	var returns NetworkPolicyShowOutputList
	_jsii_.Get(
		j,
		"showOutput",
		&returns,
...
func (j *jsiiProxy_NetworkPolicy) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NetworkPolicy) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkPolicy) Timeouts() NetworkPolicyTimeoutsOutputReference {
	var returns NetworkPolicyTimeoutsOutputReference
	_jsii_.Get(
		j,
		"timeouts",
		&returns,
...
func (j *jsiiProxy_NetworkPolicy) TimeoutsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"timeoutsInput",
...
// Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.10.0/docs/resources/network_policy snowflake_network_policy} Resource.
func NewNetworkPolicy(scope constructs.Construct, id *string, config *NetworkPolicyConfig) NetworkPolicy {
	_init_.Initialize()

	if err := validateNewNetworkPolicyParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_NetworkPolicy{}

	_jsii_.Create(
		"@cdktf/provider-snowflake.networkPolicy.NetworkPolicy",
...
func (j *jsiiProxy_NetworkPolicy)SetAllowedIpList(val *[]*string) {
	if err := j.validateSetAllowedIpListParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_NetworkPolicy)SetComment(val *string) {
...
func (j *jsiiProxy_NetworkPolicy)SetName(val *string) {
...
func NetworkPolicy_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	...
	if err := validateNetworkPolicy_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (n *jsiiProxy_NetworkPolicy) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkPolicy) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkPolicy) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (n *jsiiProxy_NetworkPolicy) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (n *jsiiProxy_NetworkPolicy) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (n *jsiiProxy_NetworkPolicy) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (n *jsiiProxy_NetworkPolicy) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (n *jsiiProxy_NetworkPolicy) GetStringAttribute(terraformAttribute *string) *string {
...
func (n *jsiiProxy_NetworkPolicy) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (n *jsiiProxy_NetworkPolicy) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkPolicy) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkPolicy) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkPolicy) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkPolicy) OverrideLogicalId(newLogicalId *string) {
...
func (n *jsiiProxy_NetworkPolicy) PutTimeouts(value *NetworkPolicyTimeouts) {
...
func (n *jsiiProxy_NetworkPolicy) ResetComment() {
	_jsii_.InvokeVoid(
		n,
		"resetComment",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPolicy) ResetId() {
	_jsii_.InvokeVoid(
		n,
		"resetId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPolicy) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		n,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPolicy) ResetTimeouts() {
	_jsii_.InvokeVoid(
		n,
		"resetTimeouts",
		nil, // no parameters
