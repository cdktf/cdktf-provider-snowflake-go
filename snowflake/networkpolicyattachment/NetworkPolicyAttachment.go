...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/networkpolicyattachment/internal"
...
func (j *jsiiProxy_NetworkPolicyAttachment) Connection() interface{} {
...
func (j *jsiiProxy_NetworkPolicyAttachment) ConstructNodeMetadata() *map[string]interface{} {
...
func (j *jsiiProxy_NetworkPolicyAttachment) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_NetworkPolicyAttachment) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetworkPolicyAttachment) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_NetworkPolicyAttachment) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_NetworkPolicyAttachment) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_NetworkPolicyAttachment) NetworkPolicyName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"networkPolicyName",
...
func (j *jsiiProxy_NetworkPolicyAttachment) NetworkPolicyNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkPolicyAttachment) Node() constructs.Node {
...
func (j *jsiiProxy_NetworkPolicyAttachment) Provisioners() *[]interface{} {
	var returns *[]interface{}
	_jsii_.Get(
		j,
		"provisioners",
...
func (j *jsiiProxy_NetworkPolicyAttachment) RawOverrides() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"rawOverrides",
...
func (j *jsiiProxy_NetworkPolicyAttachment) SetForAccount() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"setForAccount",
...
func (j *jsiiProxy_NetworkPolicyAttachment) SetForAccountInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"setForAccountInput",
...
func (j *jsiiProxy_NetworkPolicyAttachment) TerraformMetaArguments() *map[string]interface{} {
	var returns *map[string]interface{}
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkPolicyAttachment) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_NetworkPolicyAttachment) UsersInput() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"usersInput",
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.88.0/docs/resources/network_policy_attachment snowflake_network_policy_attachment} Resource.
...
// Experimental.
func NetworkPolicyAttachment_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkPolicyAttachment_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func NetworkPolicyAttachment_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateNetworkPolicyAttachment_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func NetworkPolicyAttachment_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"@cdktf/provider-snowflake.networkPolicyAttachment.NetworkPolicyAttachment",
...
func (n *jsiiProxy_NetworkPolicyAttachment) AddMoveTarget(moveTarget *string) {
...
func (n *jsiiProxy_NetworkPolicyAttachment) HasResourceMove() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkPolicyAttachment) MoveFromId(id *string) {
...
func (n *jsiiProxy_NetworkPolicyAttachment) MoveTo(moveTarget *string, index interface{}) {
...
func (n *jsiiProxy_NetworkPolicyAttachment) MoveToId(id *string) {
...
func (n *jsiiProxy_NetworkPolicyAttachment) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		n,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPolicyAttachment) ResetSetForAccount() {
	_jsii_.InvokeVoid(
		n,
		"resetSetForAccount",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPolicyAttachment) ResetUsers() {
	_jsii_.InvokeVoid(
		n,
		"resetUsers",
		nil, // no parameters
...
func (n *jsiiProxy_NetworkPolicyAttachment) SynthesizeAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkPolicyAttachment) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (n *jsiiProxy_NetworkPolicyAttachment) ToHclTerraform() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkPolicyAttachment) ToMetadata() interface{} {
	var returns interface{}
...
func (n *jsiiProxy_NetworkPolicyAttachment) ToString() *string {
	var returns *string
...
func (n *jsiiProxy_NetworkPolicyAttachment) ToTerraform() interface{} {
	var returns interface{}
