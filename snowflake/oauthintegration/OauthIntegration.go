...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/oauthintegration/internal"
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.0/docs/resources/oauth_integration snowflake_oauth_integration} Resource.
...
func OauthIntegration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateOauthIntegration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (o *jsiiProxy_OauthIntegration) AddMoveTarget(moveTarget *string) {
...
func (o *jsiiProxy_OauthIntegration) HasResourceMove() interface{} {
	var returns interface{}
...
func (o *jsiiProxy_OauthIntegration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (o *jsiiProxy_OauthIntegration) MoveFromId(id *string) {
...
func (o *jsiiProxy_OauthIntegration) MoveTo(moveTarget *string, index interface{}) {
...
func (o *jsiiProxy_OauthIntegration) MoveToId(id *string) {
...
func (o *jsiiProxy_OauthIntegration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (o *jsiiProxy_OauthIntegration) ToHclTerraform() interface{} {
	var returns interface{}
