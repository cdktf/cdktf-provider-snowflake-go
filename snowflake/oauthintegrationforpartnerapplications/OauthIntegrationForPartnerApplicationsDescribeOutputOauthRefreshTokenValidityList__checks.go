...
func (o *jsiiProxy_OauthIntegrationForPartnerApplicationsDescribeOutputOauthRefreshTokenValidityList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_OauthIntegrationForPartnerApplicationsDescribeOutputOauthRefreshTokenValidityList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewOauthIntegrationForPartnerApplicationsDescribeOutputOauthRefreshTokenValidityListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
