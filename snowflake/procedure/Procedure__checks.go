...
func (p *jsiiProxy_Procedure) validateMoveFromIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (p *jsiiProxy_Procedure) validateMoveToIdParameters(id *string) error {
	if id == nil {
		return fmt.Errorf("parameter id is required, but nil was provided")
	}
...
func (p *jsiiProxy_Procedure) validatePutArgumentsParameters(value interface{}) error {
	...
	case *[]*ProcedureArguments:
		value := value.(*[]*ProcedureArguments)
	...
	case []*ProcedureArguments:
		value_ := value.([]*ProcedureArguments)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ProcedureArguments; received %#v (a %T)", value, value)
		}
	}
