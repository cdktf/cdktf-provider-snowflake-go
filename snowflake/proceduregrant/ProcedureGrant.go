...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/proceduregrant/internal"
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.0/docs/resources/procedure_grant snowflake_procedure_grant} Resource.
...
func ProcedureGrant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateProcedureGrant_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (p *jsiiProxy_ProcedureGrant) AddMoveTarget(moveTarget *string) {
...
func (p *jsiiProxy_ProcedureGrant) HasResourceMove() interface{} {
	var returns interface{}
...
func (p *jsiiProxy_ProcedureGrant) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (p *jsiiProxy_ProcedureGrant) MoveFromId(id *string) {
...
func (p *jsiiProxy_ProcedureGrant) MoveTo(moveTarget *string, index interface{}) {
...
func (p *jsiiProxy_ProcedureGrant) MoveToId(id *string) {
...
func (p *jsiiProxy_ProcedureGrant) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (p *jsiiProxy_ProcedureGrant) ToHclTerraform() interface{} {
	var returns interface{}
