...
import (
	...
	"github.com/hashicorp/cdktf-provider-snowflake-go/snowflake/v3/proceduregrant/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

type ProcedureGrantArgumentsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) ProcedureGrantArgumentsOutputReference
...
// The jsii proxy struct for ProcedureGrantArgumentsList
type jsiiProxy_ProcedureGrantArgumentsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_ProcedureGrantArgumentsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_ProcedureGrantArgumentsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_ProcedureGrantArgumentsList) InternalValue() interface{} {
...
func (j *jsiiProxy_ProcedureGrantArgumentsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_ProcedureGrantArgumentsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_ProcedureGrantArgumentsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (p *jsiiProxy_ProcedureGrantArgumentsList) ComputeFqn() *string {
	var returns *string
...
func (p *jsiiProxy_ProcedureGrantArgumentsList) ToString() *string {
	var returns *string
