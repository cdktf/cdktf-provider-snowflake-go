...
func (j *jsiiProxy_ProcedureJavaParametersOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewProcedureJavaParametersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ProcedureJavaParametersOutputReference {
	_init_.Initialize()
...
func NewProcedureJavaParametersOutputReference_Override(p ProcedureJavaParametersOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ProcedureJavaParametersOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_ProcedureJavaParametersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_ProcedureJavaParametersOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (p *jsiiProxy_ProcedureJavaParametersOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_ProcedureJavaParametersOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
