...
func (p *jsiiProxy_ProcedureJavaParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_ProcedureJavaParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
