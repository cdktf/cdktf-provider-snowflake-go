...
func (j *jsiiProxy_ProcedureJavascriptParametersOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewProcedureJavascriptParametersOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ProcedureJavascriptParametersOutputReference {
	_init_.Initialize()
...
func NewProcedureJavascriptParametersOutputReference_Override(p ProcedureJavascriptParametersOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ProcedureJavascriptParametersOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_ProcedureJavascriptParametersOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (p *jsiiProxy_ProcedureJavascriptParametersOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (p *jsiiProxy_ProcedureJavascriptParametersOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (p *jsiiProxy_ProcedureJavascriptParametersOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
