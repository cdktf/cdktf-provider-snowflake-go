...
func (j *jsiiProxy_ProcedurePythonParametersTraceLevelList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewProcedurePythonParametersTraceLevelList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ProcedurePythonParametersTraceLevelList {
	_init_.Initialize()
...
func NewProcedurePythonParametersTraceLevelList_Override(p ProcedurePythonParametersTraceLevelList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ProcedurePythonParametersTraceLevelList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_ProcedurePythonParametersTraceLevelList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_ProcedurePythonParametersTraceLevelList) Resolve(_context cdktf.IResolveContext) interface{} {
