...
func (j *jsiiProxy_ProcedurePythonSecretsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewProcedurePythonSecretsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ProcedurePythonSecretsList {
	_init_.Initialize()
...
func NewProcedurePythonSecretsList_Override(p ProcedurePythonSecretsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ProcedurePythonSecretsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (p *jsiiProxy_ProcedurePythonSecretsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (p *jsiiProxy_ProcedurePythonSecretsList) Resolve(_context cdktf.IResolveContext) interface{} {
