...
type SnowflakeProviderConfig struct {
	...
	ExperimentalFeaturesEnabled *[]*string `field:"optional" json:"experimentalFeaturesEnabled" yaml:"experimentalFeaturesEnabled"`
	...
	OauthAuthorizationUrl *string `field:"optional" json:"oauthAuthorizationUrl" yaml:"oauthAuthorizationUrl"`
	...
	OauthTokenRequestUrl *string `field:"optional" json:"oauthTokenRequestUrl" yaml:"oauthTokenRequestUrl"`
	...
	UseLegacyTomlFile interface{} `field:"optional" json:"useLegacyTomlFile" yaml:"useLegacyTomlFile"`
	...
	WorkloadIdentityEntraResource *string `field:"optional" json:"workloadIdentityEntraResource" yaml:"workloadIdentityEntraResource"`
	...
	WorkloadIdentityProvider *string `field:"optional" json:"workloadIdentityProvider" yaml:"workloadIdentityProvider"`
}
