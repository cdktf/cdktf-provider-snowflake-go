...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "oscpFailOpen", GoGetter: "OscpFailOpen"},
			_jsii_.MemberProperty{JsiiProperty: "oscpFailOpenInput", GoGetter: "OscpFailOpenInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOscpFailOpen", GoMethod: "ResetOscpFailOpen"},
