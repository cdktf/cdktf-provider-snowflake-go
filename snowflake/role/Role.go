...
// Represents a {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.77.0/docs/resources/role snowflake_role}.
type Role interface {
...
func (j *jsiiProxy_Role) Comment() *string {
	var returns *string
	_jsii_.Get(
		j,
		"comment",
...
func (j *jsiiProxy_Role) CommentInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"commentInput",
...
func (j *jsiiProxy_Role) Tag() RoleTagList {
	var returns RoleTagList
	_jsii_.Get(
		j,
		"tag",
		&returns,
...
func (j *jsiiProxy_Role) TagInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"tagInput",
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.77.0/docs/resources/role snowflake_role} Resource.
func NewRole(scope constructs.Construct, id *string, config *RoleConfig) Role {
	...
	_jsii_.Create(
		"@cdktf/provider-snowflake.role.Role",
...
func (j *jsiiProxy_Role)SetComment(val *string) {
...
func (r *jsiiProxy_Role) PutTag(value interface{}) {
	if err := r.validatePutTagParameters(value); err != nil {
		panic(err)
	}
	_jsii_.InvokeVoid(
		r,
...
func (r *jsiiProxy_Role) ResetComment() {
	_jsii_.InvokeVoid(
		r,
		"resetComment",
		nil, // no parameters
...
func (r *jsiiProxy_Role) ResetTag() {
	_jsii_.InvokeVoid(
		r,
		"resetTag",
		nil, // no parameters
