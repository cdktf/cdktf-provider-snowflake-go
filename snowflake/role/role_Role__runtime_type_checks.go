...
func (r *jsiiProxy_Role) validatePutTagParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*RoleTag; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_Role) validateSetCommentParameters(val *string) error {
	if val == nil {
