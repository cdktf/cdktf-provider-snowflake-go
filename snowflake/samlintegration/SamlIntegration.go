...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/samlintegration/internal"
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.98.0/docs/resources/saml_integration snowflake_saml_integration} Resource.
...
func SamlIntegration_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSamlIntegration_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_SamlIntegration) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SamlIntegration) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SamlIntegration) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SamlIntegration) MoveFromId(id *string) {
...
func (s *jsiiProxy_SamlIntegration) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SamlIntegration) MoveToId(id *string) {
...
func (s *jsiiProxy_SamlIntegration) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SamlIntegration) ToHclTerraform() interface{} {
	var returns interface{}
