...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetSyncPassword", GoMethod: "ResetSyncPassword"},
			...
			_jsii_.MemberProperty{JsiiProperty: "syncPasswordInput", GoGetter: "SyncPasswordInput"},
