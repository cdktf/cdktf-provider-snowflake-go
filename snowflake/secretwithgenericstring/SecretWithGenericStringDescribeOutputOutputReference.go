...
func (j *jsiiProxy_SecretWithGenericStringDescribeOutputOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewSecretWithGenericStringDescribeOutputOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) SecretWithGenericStringDescribeOutputOutputReference {
	_init_.Initialize()
...
func NewSecretWithGenericStringDescribeOutputOutputReference_Override(s SecretWithGenericStringDescribeOutputOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_SecretWithGenericStringDescribeOutputOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_SecretWithGenericStringDescribeOutputOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecretWithGenericStringDescribeOutputOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_SecretWithGenericStringDescribeOutputOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecretWithGenericStringDescribeOutputOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
