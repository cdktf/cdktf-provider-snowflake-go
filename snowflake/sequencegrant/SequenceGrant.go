...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/sequencegrant/internal"
...
func (j *jsiiProxy_SequenceGrant) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.90.0/docs/resources/sequence_grant snowflake_sequence_grant} Resource.
func NewSequenceGrant(scope constructs.Construct, id *string, config *SequenceGrantConfig) SequenceGrant {
	_init_.Initialize()

	if err := validateNewSequenceGrantParameters(scope, id, config); err != nil {
		panic(err)
	}
...
func (j *jsiiProxy_SequenceGrant)SetCount(val interface{}) {
...
func (j *jsiiProxy_SequenceGrant)SetSequenceName(val *string) {
	if err := j.validateSetSequenceNameParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func SequenceGrant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateSequenceGrant_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func SequenceGrant_IsConstruct(x interface{}) *bool {
	...
	if err := validateSequenceGrant_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SequenceGrant_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSequenceGrant_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func SequenceGrant_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateSequenceGrant_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_SequenceGrant) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_SequenceGrant) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_SequenceGrant) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SequenceGrant) MoveFromId(id *string) {
...
func (s *jsiiProxy_SequenceGrant) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_SequenceGrant) MoveToId(id *string) {
...
func (s *jsiiProxy_SequenceGrant) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_SequenceGrant) ToHclTerraform() interface{} {
	var returns interface{}
