...
func (s *jsiiProxy_ServiceUserParametersAbortDetachedQueryOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceUserParametersAbortDetachedQueryOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
