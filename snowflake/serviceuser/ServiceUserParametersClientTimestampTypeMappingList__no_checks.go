...
func (j *jsiiProxy_ServiceUserParametersClientTimestampTypeMappingList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}
...
func validateNewServiceUserParametersClientTimestampTypeMappingListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
