...
func (s *jsiiProxy_ServiceUserParametersOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceUserParametersOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
