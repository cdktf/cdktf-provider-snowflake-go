...
func (s *jsiiProxy_ServiceUserShowOutputOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_ServiceUserShowOutputOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
