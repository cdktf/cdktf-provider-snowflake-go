...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*SessionParameter)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.sessionParameter.SessionParameterConfig",
		reflect.TypeOf((*SessionParameterConfig)(nil)).Elem(),
	)
}
