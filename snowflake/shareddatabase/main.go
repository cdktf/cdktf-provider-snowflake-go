...
func init() {
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.sharedDatabase.SharedDatabaseTimeouts",
		reflect.TypeOf((*SharedDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-snowflake.sharedDatabase.SharedDatabaseTimeoutsOutputReference",
		reflect.TypeOf((*SharedDatabaseTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
