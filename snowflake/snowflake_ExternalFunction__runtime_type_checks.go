...
func (e *jsiiProxy_ExternalFunction) validatePutArgParameters(value interface{}) error {
	...
	case *[]*ExternalFunctionArg:
		value := value.(*[]*ExternalFunctionArg)
	...
	case []*ExternalFunctionArg:
		value_ := value.([]*ExternalFunctionArg)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ExternalFunctionArg; received %#v (a %T)", value, value)
		}
	}
...
func (e *jsiiProxy_ExternalFunction) validatePutHeaderParameters(value interface{}) error {
	...
	case *[]*ExternalFunctionHeader:
		value := value.(*[]*ExternalFunctionHeader)
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
			}
	...
	case []*ExternalFunctionHeader:
		value_ := value.([]*ExternalFunctionHeader)
		value := &value_
		for idx_cd4240, v := range *value {
			if err := _jsii_.ValidateStruct(v, func() string { return fmt.Sprintf("parameter value[%#v]", idx_cd4240) }); err != nil {
				return err
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*ExternalFunctionHeader; received %#v (a %T)", value, value)
		}
	}
...
func (j *jsiiProxy_ExternalFunction) validateSetLifecycleParameters(val *cdktf.TerraformResourceLifecycle) error {
	if err := _jsii_.ValidateStruct(val, func() string { return "parameter val" }); err != nil {
		return err
	}
