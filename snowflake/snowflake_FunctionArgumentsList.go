...
type FunctionArgumentsList interface {
	cdktf.ComplexList
	...
	// Experimental.
	ComputeFqn() *string
	Get(index *float64) FunctionArgumentsOutputReference
...
// The jsii proxy struct for FunctionArgumentsList
type jsiiProxy_FunctionArgumentsList struct {
	internal.Type__cdktfComplexList
}

func (j *jsiiProxy_FunctionArgumentsList) CreationStack() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"creationStack",
...
func (j *jsiiProxy_FunctionArgumentsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_FunctionArgumentsList) InternalValue() interface{} {
...
func (j *jsiiProxy_FunctionArgumentsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_FunctionArgumentsList) TerraformResource() cdktf.IInterpolatingParent {
...
func (j *jsiiProxy_FunctionArgumentsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewFunctionArgumentsList_Override(f FunctionArgumentsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (f *jsiiProxy_FunctionArgumentsList) ComputeFqn() *string {
	var returns *string
...
func (f *jsiiProxy_FunctionArgumentsList) ToString() *string {
	var returns *string
