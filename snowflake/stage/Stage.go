...
// Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.10.0/docs/resources/stage snowflake_stage} Resource.
func NewStage(scope constructs.Construct, id *string, config *StageConfig) Stage {
	_init_.Initialize()

	if err := validateNewStageParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_Stage{}

	_jsii_.Create(
		"@cdktf/provider-snowflake.stage.Stage",
...
func (j *jsiiProxy_Stage)SetAwsExternalId(val *string) {
	if err := j.validateSetAwsExternalIdParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func (j *jsiiProxy_Stage)SetSnowflakeIamUser(val *string) {
	if err := j.validateSetSnowflakeIamUserParameters(val); err != nil {
		panic(err)
	}
	_jsii_.Set(
		j,
...
func Stage_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStage_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func Stage_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStage_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func Stage_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStage_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_Stage) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_Stage) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_Stage) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_Stage) MoveFromId(id *string) {
...
func (s *jsiiProxy_Stage) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_Stage) MoveToId(id *string) {
...
func (s *jsiiProxy_Stage) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_Stage) ToHclTerraform() interface{} {
	var returns interface{}
