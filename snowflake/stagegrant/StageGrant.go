...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/stagegrant/internal"
...
func StageGrant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStageGrant_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func (s *jsiiProxy_StageGrant) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StageGrant) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StageGrant) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StageGrant) MoveFromId(id *string) {
...
func (s *jsiiProxy_StageGrant) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StageGrant) MoveToId(id *string) {
...
func (s *jsiiProxy_StageGrant) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StageGrant) ToHclTerraform() interface{} {
	var returns interface{}
