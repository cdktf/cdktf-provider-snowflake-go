...
func (s *jsiiProxy_StorageIntegrationDescribeOutputStorageAllowedLocationsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_StorageIntegrationDescribeOutputStorageAllowedLocationsList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}
...
func validateNewStorageIntegrationDescribeOutputStorageAllowedLocationsListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
