...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "onStage", GoGetter: "OnStage"},
			_jsii_.MemberProperty{JsiiProperty: "onStageInput", GoGetter: "OnStageInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetOnStage", GoMethod: "ResetOnStage"},
