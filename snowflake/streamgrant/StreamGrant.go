...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/streamgrant/internal"
...
func (j *jsiiProxy_StreamGrant) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_StreamGrant)SetCount(val interface{}) {
...
func StreamGrant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateStreamGrant_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func StreamGrant_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStreamGrant_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func StreamGrant_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateStreamGrant_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (s *jsiiProxy_StreamGrant) AddMoveTarget(moveTarget *string) {
...
func (s *jsiiProxy_StreamGrant) HasResourceMove() interface{} {
	var returns interface{}
...
func (s *jsiiProxy_StreamGrant) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_StreamGrant) MoveFromId(id *string) {
...
func (s *jsiiProxy_StreamGrant) MoveTo(moveTarget *string, index interface{}) {
...
func (s *jsiiProxy_StreamGrant) MoveToId(id *string) {
...
func (s *jsiiProxy_StreamGrant) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (s *jsiiProxy_StreamGrant) ToHclTerraform() interface{} {
	var returns interface{}
