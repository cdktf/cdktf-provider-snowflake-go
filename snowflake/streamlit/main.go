...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "directoryLocation", GoGetter: "DirectoryLocation"},
			_jsii_.MemberProperty{JsiiProperty: "directoryLocationInput", GoGetter: "DirectoryLocationInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "mainFileInput", GoGetter: "MainFileInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetDirectoryLocation", GoMethod: "ResetDirectoryLocation"},
