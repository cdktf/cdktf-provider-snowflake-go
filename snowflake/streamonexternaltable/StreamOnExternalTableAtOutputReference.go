...
func (s *jsiiProxy_StreamOnExternalTableAtOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamOnExternalTableAtOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
