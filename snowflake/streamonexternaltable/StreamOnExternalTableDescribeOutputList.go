...
func (j *jsiiProxy_StreamOnExternalTableDescribeOutputList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_StreamOnExternalTableDescribeOutputList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_StreamOnExternalTableDescribeOutputList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_StreamOnExternalTableDescribeOutputList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_StreamOnExternalTableDescribeOutputList)SetWrapsSet(val *bool) {
...
func (s *jsiiProxy_StreamOnExternalTableDescribeOutputList) ComputeFqn() *string {
	var returns *string
...
func (s *jsiiProxy_StreamOnExternalTableDescribeOutputList) Get(index *float64) StreamOnExternalTableDescribeOutputOutputReference {
	if err := s.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns StreamOnExternalTableDescribeOutputOutputReference
...
func (s *jsiiProxy_StreamOnExternalTableDescribeOutputList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (s *jsiiProxy_StreamOnExternalTableDescribeOutputList) ToString() *string {
	var returns *string
