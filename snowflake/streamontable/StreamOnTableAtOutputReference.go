...
func (j *jsiiProxy_StreamOnTableAtOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewStreamOnTableAtOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) StreamOnTableAtOutputReference {
	_init_.Initialize()
...
func NewStreamOnTableAtOutputReference_Override(s StreamOnTableAtOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) {
	_init_.Initialize()
...
func (j *jsiiProxy_StreamOnTableAtOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (s *jsiiProxy_StreamOnTableAtOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamOnTableAtOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (s *jsiiProxy_StreamOnTableAtOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamOnTableAtOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
