...
func (s *jsiiProxy_StreamOnTableAtOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamOnTableAtOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
