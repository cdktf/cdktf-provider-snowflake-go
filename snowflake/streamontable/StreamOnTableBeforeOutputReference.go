...
func (s *jsiiProxy_StreamOnTableBeforeOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamOnTableBeforeOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
