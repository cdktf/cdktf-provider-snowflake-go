...
func (s *jsiiProxy_StreamOnViewAtOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_StreamOnViewAtOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
