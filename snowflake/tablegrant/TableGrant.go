...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/tablegrant/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/table_grant snowflake_table_grant}.
...
func (j *jsiiProxy_TableGrant) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_TableGrant) OnAll() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"onAll",
...
func (j *jsiiProxy_TableGrant) OnAllInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"onAllInput",
...
func (j *jsiiProxy_TableGrant) RevertOwnershipToRoleName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TableGrant) RevertOwnershipToRoleNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
// Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/table_grant snowflake_table_grant} Resource.
func NewTableGrant(scope constructs.Construct, id *string, config *TableGrantConfig) TableGrant {
	...
	_jsii_.Create(
		"@cdktf/provider-snowflake.tableGrant.TableGrant",
...
func (j *jsiiProxy_TableGrant)SetCount(val interface{}) {
...
func (j *jsiiProxy_TableGrant)SetOnAll(val interface{}) {
...
func (j *jsiiProxy_TableGrant)SetRevertOwnershipToRoleName(val *string) {
...
func TableGrant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTableGrant_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
// Experimental.
func TableGrant_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTableGrant_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TableGrant_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTableGrant_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (t *jsiiProxy_TableGrant) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TableGrant) HasResourceMove() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TableGrant) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_TableGrant) MoveFromId(id *string) {
...
func (t *jsiiProxy_TableGrant) MoveTo(moveTarget *string, index interface{}) {
...
func (t *jsiiProxy_TableGrant) MoveToId(id *string) {
...
func (t *jsiiProxy_TableGrant) ResetOnAll() {
	_jsii_.InvokeVoid(
		t,
		"resetOnAll",
		nil, // no parameters
...
func (t *jsiiProxy_TableGrant) ResetRevertOwnershipToRoleName() {
	_jsii_.InvokeVoid(
		t,
		"resetRevertOwnershipToRoleName",
		nil, // no parameters
...
func (t *jsiiProxy_TableGrant) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TableGrant) ToHclTerraform() interface{} {
	var returns interface{}
