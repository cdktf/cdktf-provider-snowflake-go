...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "maskingPoliciesInput", GoGetter: "MaskingPoliciesInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetMaskingPolicies", GoMethod: "ResetMaskingPolicies"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.tag.TagShowOutput",
		reflect.TypeOf((*TagShowOutput)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-snowflake.tag.TagShowOutputList",
		reflect.TypeOf((*TagShowOutputList)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*TagShowOutputOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "allowedValues", GoGetter: "AllowedValues"},
			_jsii_.MemberProperty{JsiiProperty: "comment", GoGetter: "Comment"},
	...
	_jsii_.RegisterStruct(
		"@cdktf/provider-snowflake.tag.TagTimeouts",
		reflect.TypeOf((*TagTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"@cdktf/provider-snowflake.tag.TagTimeoutsOutputReference",
		reflect.TypeOf((*TagTimeoutsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIndex", GoGetter: "ComplexObjectIndex"},
			_jsii_.MemberProperty{JsiiProperty: "complexObjectIsFromSet", GoGetter: "ComplexObjectIsFromSet"},
			_jsii_.MemberMethod{JsiiMethod: "computeFqn", GoMethod: "ComputeFqn"},
