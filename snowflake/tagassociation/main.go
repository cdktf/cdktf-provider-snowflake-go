...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "objectIdentifiers", GoGetter: "ObjectIdentifiers"},
			_jsii_.MemberProperty{JsiiProperty: "objectIdentifiersInput", GoGetter: "ObjectIdentifiersInput"},
