...
func (j *jsiiProxy_TaskParametersEnableUnloadPhysicalTypeOptimizationList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewTaskParametersEnableUnloadPhysicalTypeOptimizationList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) TaskParametersEnableUnloadPhysicalTypeOptimizationList {
	_init_.Initialize()
...
func NewTaskParametersEnableUnloadPhysicalTypeOptimizationList_Override(t TaskParametersEnableUnloadPhysicalTypeOptimizationList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_TaskParametersEnableUnloadPhysicalTypeOptimizationList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (t *jsiiProxy_TaskParametersEnableUnloadPhysicalTypeOptimizationList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (t *jsiiProxy_TaskParametersEnableUnloadPhysicalTypeOptimizationList) Resolve(_context cdktf.IResolveContext) interface{} {
