...
func (t *jsiiProxy_TaskParametersLogLevelOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (t *jsiiProxy_TaskParametersLogLevelOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
