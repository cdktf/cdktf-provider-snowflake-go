...
import (
	...
	"github.com/hashicorp/cdktf-provider-snowflake-go/snowflake/v3/task/internal"
...
func (j *jsiiProxy_Task) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_Task)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
