...
import (
	...
	"github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/taskgrant/internal"
...
func (j *jsiiProxy_TaskGrant) Count() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_TaskGrant) OnAll() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"onAll",
...
func (j *jsiiProxy_TaskGrant) OnAllInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"onAllInput",
...
func (j *jsiiProxy_TaskGrant) RevertOwnershipToRoleName() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_TaskGrant) RevertOwnershipToRoleNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewTaskGrant(scope constructs.Construct, id *string, config *TaskGrantConfig) TaskGrant {
	...
	if err := validateNewTaskGrantParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_TaskGrant{}

	_jsii_.Create(
		"@cdktf/provider-snowflake.taskGrant.TaskGrant",
...
func (j *jsiiProxy_TaskGrant)SetCount(val interface{}) {
...
func (j *jsiiProxy_TaskGrant)SetOnAll(val interface{}) {
...
func (j *jsiiProxy_TaskGrant)SetRevertOwnershipToRoleName(val *string) {
...
func TaskGrant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()

	if err := validateTaskGrant_GenerateConfigForImportParameters(scope, importToId, importFromId); err != nil {
		panic(err)
	}
...
func TaskGrant_IsConstruct(x interface{}) *bool {
	...
	if err := validateTaskGrant_IsConstructParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TaskGrant_IsTerraformElement(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTaskGrant_IsTerraformElementParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
// Experimental.
func TaskGrant_IsTerraformResource(x interface{}) *bool {
	_init_.Initialize()

	if err := validateTaskGrant_IsTerraformResourceParameters(x); err != nil {
		panic(err)
	}
	var returns *bool
...
func (t *jsiiProxy_TaskGrant) AddMoveTarget(moveTarget *string) {
...
func (t *jsiiProxy_TaskGrant) HasResourceMove() interface{} {
	var returns interface{}
...
func (t *jsiiProxy_TaskGrant) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (t *jsiiProxy_TaskGrant) MoveFromId(id *string) {
...
func (t *jsiiProxy_TaskGrant) MoveTo(moveTarget *string, index interface{}) {
...
func (t *jsiiProxy_TaskGrant) MoveToId(id *string) {
...
func (t *jsiiProxy_TaskGrant) ResetOnAll() {
	_jsii_.InvokeVoid(
		t,
		"resetOnAll",
		nil, // no parameters
...
func (t *jsiiProxy_TaskGrant) ResetRevertOwnershipToRoleName() {
	_jsii_.InvokeVoid(
		t,
		"resetRevertOwnershipToRoleName",
		nil, // no parameters
...
func (t *jsiiProxy_TaskGrant) SynthesizeHclAttributes() *map[string]interface{} {
	var returns *map[string]interface{}
...
func (t *jsiiProxy_TaskGrant) ToHclTerraform() interface{} {
	var returns interface{}
