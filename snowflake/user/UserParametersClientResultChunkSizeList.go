...
func (j *jsiiProxy_UserParametersClientResultChunkSizeList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserParametersClientResultChunkSizeList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_UserParametersClientResultChunkSizeList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_UserParametersClientResultChunkSizeList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_UserParametersClientResultChunkSizeList)SetWrapsSet(val *bool) {
...
func (u *jsiiProxy_UserParametersClientResultChunkSizeList) ComputeFqn() *string {
	var returns *string
...
func (u *jsiiProxy_UserParametersClientResultChunkSizeList) Get(index *float64) UserParametersClientResultChunkSizeOutputReference {
	if err := u.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns UserParametersClientResultChunkSizeOutputReference
...
func (u *jsiiProxy_UserParametersClientResultChunkSizeList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (u *jsiiProxy_UserParametersClientResultChunkSizeList) ToString() *string {
	var returns *string
