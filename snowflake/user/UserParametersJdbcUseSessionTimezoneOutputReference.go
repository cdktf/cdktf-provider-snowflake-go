...
func (u *jsiiProxy_UserParametersJdbcUseSessionTimezoneOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserParametersJdbcUseSessionTimezoneOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
