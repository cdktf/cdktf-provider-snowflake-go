...
func (j *jsiiProxy_UserParametersJsonIndentList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_UserParametersJsonIndentList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_UserParametersJsonIndentList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_UserParametersJsonIndentList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_UserParametersJsonIndentList)SetWrapsSet(val *bool) {
...
func (u *jsiiProxy_UserParametersJsonIndentList) ComputeFqn() *string {
	var returns *string
...
func (u *jsiiProxy_UserParametersJsonIndentList) Get(index *float64) UserParametersJsonIndentOutputReference {
	if err := u.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns UserParametersJsonIndentOutputReference
...
func (u *jsiiProxy_UserParametersJsonIndentList) Resolve(_context cdktf.IResolveContext) interface{} {
...
func (u *jsiiProxy_UserParametersJsonIndentList) ToString() *string {
	var returns *string
