...
func (u *jsiiProxy_UserParametersQueryTagOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserParametersQueryTagOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
