...
func (u *jsiiProxy_UserParametersStatementTimeoutInSecondsOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserParametersStatementTimeoutInSecondsOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
