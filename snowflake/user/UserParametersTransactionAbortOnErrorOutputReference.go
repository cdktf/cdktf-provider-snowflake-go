...
func (u *jsiiProxy_UserParametersTransactionAbortOnErrorOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (u *jsiiProxy_UserParametersTransactionAbortOnErrorOutputReference) Resolve(context cdktf.IResolveContext) interface{} {
