...
type UserAuthenticationPolicyAttachmentConfig struct {
	// Experimental.
	...
	AuthenticationPolicyName *string `field:"required" json:"authenticationPolicyName" yaml:"authenticationPolicyName"`
	...
	Timeouts *UserAuthenticationPolicyAttachmentTimeouts `field:"optional" json:"timeouts" yaml:"timeouts"`
}
