...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "expireRotatedTokenAfterHours", GoGetter: "ExpireRotatedTokenAfterHours"},
			_jsii_.MemberProperty{JsiiProperty: "expireRotatedTokenAfterHoursInput", GoGetter: "ExpireRotatedTokenAfterHoursInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "keeper", GoGetter: "Keeper"},
			_jsii_.MemberProperty{JsiiProperty: "keeperInput", GoGetter: "KeeperInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "minsToBypassNetworkPolicyRequirementInput", GoGetter: "MinsToBypassNetworkPolicyRequirementInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetExpireRotatedTokenAfterHours", GoMethod: "ResetExpireRotatedTokenAfterHours"},
			_jsii_.MemberMethod{JsiiMethod: "resetId", GoMethod: "ResetId"},
			_jsii_.MemberMethod{JsiiMethod: "resetKeeper", GoMethod: "ResetKeeper"},
			_jsii_.MemberMethod{JsiiMethod: "resetMinsToBypassNetworkPolicyRequirement", GoMethod: "ResetMinsToBypassNetworkPolicyRequirement"},
			_jsii_.MemberMethod{JsiiMethod: "resetOverrideLogicalId", GoMethod: "ResetOverrideLogicalId"},
			_jsii_.MemberMethod{JsiiMethod: "resetRoleRestriction", GoMethod: "ResetRoleRestriction"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "roleRestriction", GoGetter: "RoleRestriction"},
			_jsii_.MemberProperty{JsiiProperty: "roleRestrictionInput", GoGetter: "RoleRestrictionInput"},
			_jsii_.MemberProperty{JsiiProperty: "rotatedTokenName", GoGetter: "RotatedTokenName"},
