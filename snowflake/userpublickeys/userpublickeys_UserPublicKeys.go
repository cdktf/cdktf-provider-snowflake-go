...
import (
	...
	"github.com/hashicorp/cdktf-provider-snowflake-go/snowflake/v3/userpublickeys/internal"
...
func (j *jsiiProxy_UserPublicKeys) Count() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"count",
...
func (j *jsiiProxy_UserPublicKeys)SetCount(val *float64) {
	_jsii_.Set(
		j,
		"count",
		val,
