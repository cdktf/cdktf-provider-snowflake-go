...
func (v *jsiiProxy_ViewDescribeOutputOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (v *jsiiProxy_ViewDescribeOutputOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
