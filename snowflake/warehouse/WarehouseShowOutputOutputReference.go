...
func (w *jsiiProxy_WarehouseShowOutputOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (w *jsiiProxy_WarehouseShowOutputOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
