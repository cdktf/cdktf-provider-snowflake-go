...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "resetResourceConstraint", GoMethod: "ResetResourceConstraint"},
			...
			_jsii_.MemberProperty{JsiiProperty: "resourceConstraintInput", GoGetter: "ResourceConstraintInput"},
